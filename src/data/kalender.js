...
export const KALENDER_2026 = [
  ...
  { nr: 4,  code: "BHR", naam: "Bahrein",          circuit: "Bahrain International",   datum: "2026-04-12", sprint: false },
  { nr: 5,  code: "SAU", naam: "Saoedi-Arabië",    circuit: "Jeddah",                  datum: "2026-04-19", sprint: false },
  { nr: 6,  code: "MIA", naam: "Miami",            circuit: "Miami International",     datum: "2026-05-03", sprint: true  },
  { nr: 7,  code: "CAN", naam: "Canada",           circuit: "Gilles Villeneuve",       datum: "2026-05-24", sprint: false },
  ...
  { nr: 21, code: "BRA", naam: "São Paulo",        circuit: "Interlagos",              datum: "2026-11-08", sprint: true  },
  { nr: 22, code: "LVG", naam: "Las Vegas",        circuit: "Las Vegas Strip",         datum: "2026-11-21", sprint: false },
  { nr: 23, code: "QAT", naam: "Qatar",            circuit: "Lusail International",    datum: "2026-11-29", sprint: true  },
